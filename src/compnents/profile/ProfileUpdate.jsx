...
//             try {
//                 const response = await fetch(`backend-healthmate-khusburai.onrender.com/${username}/getuserdetails`);
...
//             const response = await axios.patch(`backend-healthmate-khusburai.onrender.com/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});
