...
//             try {
//                 const response = await fetch(`/${username}/getuserdetails`);
...
//             const response = await axios.patch(`/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});
